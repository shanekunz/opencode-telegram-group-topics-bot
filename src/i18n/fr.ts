...
export const fr: I18nDictionary = {
  ...
  "cmd.description.ls": "Lister les fichiers du projet",
  "cmd.description.tts": "Basculer les réponses audio",
  "ls.open_error": "🔴 Impossible d'ouvrir l'explorateur de fichiers du projet.",
  "ls.access_denied": "⛔ Accès refusé : le chemin est hors du projet actuel",
  "ls.scan_error": "🔴 Impossible de lister le dossier",
  "ls.header": "Contenu du dossier",
  ...
  "commands.download.file_too_large": "Le fichier est trop volumineux pour Telegram.",
