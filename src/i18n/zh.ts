...
export const zh: I18nDictionary = {
  ...
  "ls.open_error": "🔴 无法打开项目文件浏览器。",
  "ls.access_denied": "⛔ 拒绝访问：路径不在当前项目内",
  ...
  "commands.download.file_too_large": "文件过大，无法通过 Telegram 发送。",
  ...
  "task.run.error.interactive_question": "定时任务无法继续，因为它需要交互式回答问题。",
  "task.run.error.interactive_permission": "定时任务无法继续，因为它需要交互式权限批准。",
