...
export const ru: I18nDictionary = {
  ...
  "task.schedule_prompt":
    "Отправьте расписание для этой задачи. Примеры: `каждый будний день в 09:00` или `завтра в 18:30`.\n\nЭта задача при завершении создания использует текущие настройки агента и модели из 🎛️ Session Control.",
  ...
  "task.prompt_prompt":
    "Отправьте промпт для этой отложенной задачи. Она сохранит текущие настройки агента и модели из 🎛️ Session Control на момент создания.",
  "task.schedule_error":
